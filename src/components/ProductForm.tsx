...
function ProductForm({
   ...
   const [properties, setProperties]: any = useState(existingProperties);
   const [property, setproperty] = useState({
      name: "",
      value: "",
   });
   const [price, setPrice] = useState(existingPrice);
   const [desciption, setdesciption] = useState(existingProductDescription);
   ...
   const UserID = existingAddedBy;
   const [links, setlinks] = useState(existingImages);
   ...
   return (
      <div className="bg w-full p-3 py-5 mt-4 rounded-2xl min-h-[300px]">
         <div className="bg-white py-4 px-3 w-full rounded-2xl cus-shad">
            <h2 className="text-center text-[22px]">Update Product</h2>
            <div className="p-1 py-2 rounded-2xl bg-white cus-shad mt-4 w-full flex flex-col items-start justify-start gap-y-3">
               ...
               <div className="w-full flex flex-wrap items-center justify-center gap-2">
                  <div className="basis-[47%] min-w-[340px]">
                     <label htmlFor="productName" className="block mb-1 ml-1">
                        <h4>Product Name</h4>
                     </label>
                     <input
                  ...
                  <div className="basis-[47%] min-w-[340px]">
                     <label htmlFor="productPrice" className="block mb-1 ml-1">
                        <h3>Product Price</h3>
                     </label>
                     <input
                        className="bg-white border-[0.5px] sm-shad text-black outline-none transition-all focus:cus-shad rounded-3xl p-3 w-full"
               ...
               <div className="w-full px-[26px]">
                  <div className="w-full">
                     <label htmlFor="productDesc" className="block mb-1 ml-1">
               ...
               <div className="w-full flex flex-wrap items-center justify-center gap-2">
                  <div className="basis-[47%] min-w-[340px]">
                     <label htmlFor="productStock" className="block mb-1 ml-1">
                        <h3>Product Stock</h3>
                     </label>
                     <input
                        className="bg-white border-[0.5px] sm-shad text-black outline-none transition-all focus:cus-shad rounded-3xl p-3 w-full"
                  ...
                  {properties.length > 0 &&
                     properties.map((prop: any, index: number) => (
                        ...
                        >
                           ...
                           <div>
                              <button className="bg-grd rounded-3xl text-white w-[120px] py-3">
                                 Edit
                              </button>
                           </div>
                           <div>
                              <button className="red-grd rounded-3xl text-white w-[120px] py-3">
                                 Delete
                              </button>
                           </div>
                        </div>
