...
function Header() {
   ...
   const activeLink = `cus-shad2 grd transition-all rounded-xl`;
         ...
         {session.status === "authenticated" ? (
            <div className="sidebar s-sh hidden sm:block rounded-r-[20px]">
               ...
               >
                  ...
                  <h2 className="mt-[2px] text-[17px] font-medium">
                     Dashboard
                  </h2>
               </Link>
               <Link
               ...
               <Link
                  onClick={(ev) => signOut({ callbackUrl: "/sign-in" })}
                  href={"#"}
                  className={`w-full flex  align-middle pl-10 justify-start text-gray-500 py-4 transition-all  `}
               >
                  <LogOutIcon className={"mr-3"} />
                  <h2 className="mt-[2px] text-[17px] font-medium">Logout</h2>
               </Link>
            </div>
         ) : (
            ""
